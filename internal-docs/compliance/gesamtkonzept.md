...
- `app/protected/paste/[slug]/page.tsx`, `app/api/pastes/[slug]/unlock/route.ts`, `app/p/[slug]/page.tsx`, `app/p/[slug]/raw/route.ts`, `lib/paste-access.ts`: technisch geschlossener Paste-Passwort- und Raw-/Ablauf-Bypass mit POST, bcrypt, HMAC-Cookie und 15 Regressionstests.
...
| Paste-Passwortschutz oder Zugriffsnachweis regrediert; produktive Cookie-/Secret-Konfiguration ist unbestaetigt | Unbefugte Offenlegung vertraulicher Inhalte | Niedrig nach Codefix, betrieblich unbestaetigt | POST-basierten bcrypt-Vergleich, HMAC-Bindung an Slug/Hash/Ablauf und konsistente Haupt-/Raw-/Ablaufkontrollen erhalten | 15 Regressionstests sowie produktionsnaher Browser-, Cookie- und Proxy-Log-Test | Paste-Routen, `lib/paste-access.ts`; technischer Commit `44daa90` |
...
| 21.07.2026 | Compliance-Dokumentation | Paste-Datenfluss, geschlossenen Passwort-/Raw-/Ablauf-Bypass, gebundenen HttpOnly-Nachweis und 15 Regressionstests aufgenommen; produktive Cookie-/Proxy-/Secret-Evidenz bleibt offen | Daily Evolution bis Commit `44daa90` |
