...
// Mock data initially, will replace with real data fetching
// Note: In a real implementation we would fetch this from server component or SWR
const MOCK_TEAMS = [
  // { id: 1, name: 'Marketing Team', role: 'owner', memberCount: 3 },
  // { id: 2, name: 'Developers', role: 'member', memberCount: 5 },
];
